...
class AssetBiayaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Jika aset biaya kategori Kendaraan, simpan detail kendaraan
        ...
        // Histori awal jika ada pemegang
        ...
        return redirect()->route('assets-biaya.index')
            ->with('success', 'Aset Biaya berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, Asset $asset)
    {
        ...
        return redirect()->route('assets-biaya.index')
            ->with('success', 'Aset Biaya berhasil diupdate!');
    }
    ...
    public function destroy(Asset $asset)
    {
        ...
        return redirect()->route('assets-biaya.index')
            ->with('success', 'Aset Biaya berhasil dihapus!');
    }
