...
class AssetPinjamanController extends Controller
{
    ...
    public function update(Request $request, Asset $asset)
    {
        ...
        return redirect()->route('assets-pinjaman.index')->with('success', 'Aset Pinjaman berhasil diupdate!');
    }
    ...
    public function destroy(Asset $asset)
    {
        if ($asset->foto) Storage::disk('public')->delete($asset->foto);
        $asset->delete();
        return redirect()->route('assets-pinjaman.index')->with('success', 'Aset Pinjaman berhasil dihapus!');
    }
