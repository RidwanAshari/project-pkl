...
@section('title', 'Data Aset Pinjaman')

@section('content')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Aset Pinjaman</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('assets-pinjaman.index') }}" class="row g-3">
                <div class="col-md-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ route('assets-pinjaman.edit', $asset) }}" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
                                    <form action="{{ route('assets-pinjaman.destroy', $asset) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                        @csrf @method('DELETE')
