...
@section('title', 'Tambah Aset Biaya')

@section('content')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Aset Biaya</h1>
        <a href="{{ route('assets-biaya.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('assets-biaya.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- Detail Kendaraan (muncul jika kategori = Kendaraan) -->
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Simpan Aset Biaya
                            </button>
                        </div>
                    </form>
                </div>
